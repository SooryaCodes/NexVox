      ...
      >
        <div className="relative bg-black/90 border border-[#00FFFF]/30 rounded-lg overflow-hidden">
          ...
          <div className="p-8 relative z-10">
            ...
            <m.button 
              className="w-full relative py-4 rounded-md bg-gradient-to-r from-[#00FFFF]/10 to-[#9D00FF]/10 border border-[#00FFFF]/50 group overflow-hidden"
              whileHover={{ 
                scale: 1.02,
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-30 pointer-events-none">
                <div className="h-[1px] w-full bg-[#00FFFF]/70 absolute -left-full animate-[scan_2s_linear_infinite]"></div>
              </div>
              
              {/* Button content */}
              <div className="flex items-center justify-center gap-3 relative z-10">
                <div className="w-7 h-7 rounded-full bg-[#00FFFF]/20 flex items-center justify-center">
                ...
                <span className="text-[#00FFFF] font-medium tracking-wide">START CONVERSATION</span>
              </div>
