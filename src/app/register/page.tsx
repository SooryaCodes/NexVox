...
export default function Register() {
  ...
  // Initialize sound context - using it correctly
      ...
      <div className="container mx-auto max-w-7xl z-10 flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        >
          <div className="text-center lg:text-left mb-8">
            ...
            >
              Create <span className="text-[#00FFFF]">Account</span>
            </h1>
            <p className="text-lg text-gray-300">
              Join the next-generation voice platform for global connections
            </p>
            <div className="mt-6 bg-black/40 backdrop-blur-sm border border-[#9D00FF]/30 p-4 rounded-md">
          ...
          {/* Decorative element */}
          <div className="hidden lg:block h-1 w-full bg-gradient-to-r from-[#9D00FF] via-[#00FFFF] to-[#9D00FF] rounded-full opacity-70"></div>
          
          {/* Cyberpunk decoration - matching login page */}
        ...
        >
          {registerSuccess ? (
            <div className="w-full max-w-md flex flex-col items-center justify-center">
              ...
              <h2 className="mt-8 text-2xl font-orbitron text-[#00FFFF] glow">Registration Complete</h2>
              ...
              <div className="mt-8 w-full max-w-xs bg-black/60 border border-[#00FFFF]/30 p-4 rounded-md font-mono text-sm">
                <p className="text-[#00FFFF]">{'>'} Creating user profile...</p>
                <p className="text-[#00FFFF]">{'>'} Generating access tokens...</p>
